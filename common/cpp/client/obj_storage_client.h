...
namespace doris {
// Numeric values are kept aligned with TObjStorageType.
...
public:
    ...
    virtual ObjectStorageResponse head_bucket(const std::string& /*bucket*/) {
...
public:
    ...
    ObjectStorageResponse head_bucket(const std::string& bucket);
