...
TEST_F(S3ClientFactoryTest, ObjClientHolderResetDistinguishesHashCollisions) {
    ...
    auto external_provider_client =
            std::make_shared<io::S3ObjStorageClient>(std::shared_ptr<Aws::S3::S3Client> {});
    auto internal_provider_client =
            std::make_shared<io::S3ObjStorageClient>(std::shared_ptr<Aws::S3::S3Client> {});
    auto external_client = std::make_shared<io::ObjStorageClient>(external_provider_client);
    auto internal_client = std::make_shared<io::ObjStorageClient>(internal_provider_client);
    int create_count = 0;
